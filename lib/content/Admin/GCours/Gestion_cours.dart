...
class GestionCours extends StatefulWidget {
  ...
  GestionCours({@required this.admin});
  @override
  State<StatefulWidget> createState() {
    admins = admin;
    print("Admin---------");
    print(admins.toString());
    return _GestionCourState();
  }
}

class _GestionCourState extends State<GestionCours> {
  File _file;
  String _fileName;
  String _path;
  ...
  Future uploadFile() async {
    print("---------------------ENTRE UPLOAD FILE -----------------");
    _reference = FirebaseStorage.instance.ref().child(fileImport.name);
    ...
    print(taskSnapshot.uploadSessionUri);
    print(taskSnapshot.storageMetadata.name);
    String downloadAddress = await _reference.getDownloadURL();
    print(downloadAddress);

    setState(() {
      filecour = downloadAddress;
      _uplaodFile = true;
    });
    print("---------------------Sorti UPLOAD FILE -----------------");
  }
...
class _CoursList extends State<CoursList> {
  ...
  void openfile(String _url) async =>
