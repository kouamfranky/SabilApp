...
class GestionSalles extends StatefulWidget {
   final Administrateur admin;
  GestionSalles({@required this.admin});
  @override
  State<StatefulWidget> createState() {
    admins=admin;
    return _GestionSalleState();
  }
}

class _GestionSalleState extends State<GestionSalles> {
  String _titre;
  String _competence;
  String _durree;
  String _file;
...
class _CoursList extends State<CoursList> {
          ...
          child: IconSlideAction(
            ...
            onTap: () {
              ...
              Navigator.push(context,
                  MaterialPageRoute(builder: (context) => GestionSalles()));
            },
          ),
        ),
        Container(
  ...
  OnEdit(Cours cours) {
    ...
    Navigator.push(
        context, MaterialPageRoute(builder: (context) => GestionSalles()));
  }
}
